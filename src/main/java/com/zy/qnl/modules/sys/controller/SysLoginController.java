...
import com.zy.qnl.modules.sys.form.SysLoginForm;
import com.zy.qnl.modules.sys.service.SysCaptchaService;
...
public class SysLoginController extends AbstractController {
	...
	@GetMapping("/sys/test")
	public R test(String userName)throws IOException {
		SysUserEntity sysUserEntity = sysUserService.queryByUserName(userName);
		redisUtils.set("testSysUser3",sysUserEntity);
